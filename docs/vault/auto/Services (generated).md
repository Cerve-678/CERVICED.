...
`AvailabilityService` · `describeEmergencyReason` · `earliestBookableStartMs` · `isStartTaken` · `parseDurationToMinutes` · `parseTimeToMinutes` · `resolveSlotOffer` · `resolveWorkingWindows` · `slotStartMs` · `snapToRequestable` · `toWindowMins`
