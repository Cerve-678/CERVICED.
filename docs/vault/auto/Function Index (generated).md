...
**2128 functions** across **273 files**.
...
- `SearchScreen.tsx` — activeFilterChips · availabilityCandidateIds · availabilityMissingIds · clearFilter · clearFilterKeys · filteredProviders · formatNextAvailable · formatPriceRange · handleFilterPress · handleRefresh · handleSearchChange · mapDbToCardData · matchedServiceByProviderId · openProvider · priceRangeByProviderId · providersWithAvailability · providersWithDistance · providersWithPriceRange · renderHeader · resetFilters · run · SearchScreen · specialtiesFor · updateCityFilter · updateFilter
...
- `serviceFilterMatch.ts` — **hasServiceCriteria** · **pickMatchingService** · **priceRangeAcrossServices** · **serviceMatchesCriteria** · **serviceRange**
