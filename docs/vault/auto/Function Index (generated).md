...
**1435 functions** across **183 files**.
...
- `BookingSheet.tsx` — **BookingSheet** · depositPolicyArg · handleLocalApplyPromo · handleLocalRemovePromo · handleSubmit · localPromoDiscount · summaryRemaining · toggleAddOn · tokens · totalAddOnsPrice
- `CartTabBadge.tsx` — **useCartBadge**
- `CategoryTabPill.tsx` — animatedStyle · handlePressIn · handlePressOut
- `ChatComponents.tsx` — ActionCard · **AmbientMark** · animatedStyle · **ChatBubble** · **ChatInput** · handleImagePick · handlePress · handlePressIn · handlePressOut · handleSend · **Mark** · PillChip · **ProviderRecommendations** · **renderRichText** · **stripRichText** · **Suggestions** · **ThinkingIndicator**
...
- `engine.ts` — buildAmbiguityReply · buildAssumption · buildFallback · buildMissingEntityReply · **confirmToken** · defaultFollowUps · defaultStarters · loadPersonalContext · message_ · **respond** · runPendingAction · setPendingAction · topUp
