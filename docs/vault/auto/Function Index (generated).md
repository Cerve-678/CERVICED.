...
- `BookingSheet.tsx` — **BookingSheet** · depositPolicyArg · goToStep · handleBack · handleLocalApplyPromo · handleLocalRemovePromo · handleNext · handleSubmit · localPromoDiscount · stepBlocker · summaryRemaining · toggleAddOn · tokens · totalAddOnsPrice
- `CartTabBadge.tsx` — **useCartBadge**
- `CategoryTabPill.tsx` — animatedStyle · handlePressIn · handlePressOut
- `ChatComponents.tsx` — ActionCard · **AmbientMark** · animatedStyle · **ChatBubble** · **ChatInput** · handleImagePick · handlePress · handlePressIn · handlePressOut · handleSend · **Mark** · PillChip · **ProviderRecommendations** · renderInlineRichText · **renderRichText** · **stripRichText** · **Suggestions** · **ThinkingIndicator**
...
- `MultiBookingSheet.tsx` — depositPolicyArg · goToStep · groupRangeText · groupSchedule · groupServices · groupSlotResolver · handleBack · handleNext · handleSubmit · **MultiBookingSheet** · separateServicesList · servicesTotal · stepBlocker · toggleSeparate · tokens · totalAddOnsPrice
...
### `src/features/bookings/` (2)
- `presentation.ts` — format · **formatBookingDate** · nextDay · **resolveRescheduleDateLabel**
- `receipt.ts` — **buildClientReceiptHTML**
...
- `BookingsScreen.tsx` — addDate · badgeColor · badgeText · BookingsScreen · buildLegacyClientReceiptHTML · calculatePaymentBreakdown · confirmRebook · const · createStyles · filteredPastBookings · filteredUpcomingBookings · focusMapOnLocation · formattedDate · getNextDay · getStatusColor · getUserLocation · handleBookingPress · handleCancelBooking · handleConfirmWaitlistHold · handleDeclineWaitlistHold · handlePress · handleRatingSubmit · handleRebook · handleRescheduleConfirm · handleRescheduleRequest · handleSendMessage · handleShareReceipt · handleTap · handleTipSubmit · hasBookingBeenRated · hasBookingBeenTipped · HiddenDevMenuTrigger · isMessagingAvailable · listItems · onRefresh · openContactSheet · openInMaps · openProviderChat · overallStatus · platformFee · refreshBookingActionItems · renderServiceCategoryRow · resolveServiceCategory · retryLoadBookings · routeCoordinates · styles · to · toggleFilter · toggleGroup · totalBasePrice
...
- `CartScreen.tsx` — addOnsSummary · bookingsByItemId · bookingSummary · buildRenderUnits · CartScreen · checkoutRenderUnits · depositPolicyArg · durationToMinutes · dynamicStyles · effectiveCartItems · effectiveFinalTotal · effectivePrice · effectiveTotal · effectiveTotalNoPromo · formatCardNumber · formatExpiry · formatTimeSpan · fullPriceOf · getServiceBooking · groupRemaining · groupRescheduleChain · groupRescheduleSpanLabel · groupServiceTotal · groupSlotResolver · groupTotal · handleApplyPromoToProvider · handleBookingSheetEditSubmit · handleCheckout · handleClearCart · handleConfirmGroupReschedule · handleContinueShopping · handleEditItem · handlePayment · handlePaymentSuccess · handlePickerSelect · handlePickerSelectGroup · handleRemove · handleRemoveOne · handleReviewConfirm · hasDeposit · hasDepositItem · hasUnscheduledItems · itemPromoDiscounts · itemsByProvider · navigateToProvider · onRefresh · priceOf · promoSavingsShown · renderAddOns · timestamp · to24hMinutes · toggleProviderCollapsed · toLabel · totalPrice · totalPromoDiscount
- `ClientIntakeFormScreen.tsx` — ClientIntakeFormScreen · handleSubmit · QuestionInput · setAnswer
- `ExploreScreen.tsx` — columnWidth · filters · filterTabs · getItemHeight · handleBookNow · handleCloseDetail · handleImagePress · handleOpenSearch · handleViewProfile · interleaveDiscoverFeed · load · mapDbPortfolioItem · mapDbProviderToCard · mapDbServiceToCards · mapDbUnclaimedProviderToCard · renderPortfolioCard · SkeletonMasonryGrid
...
- `ProviderBookingDetailScreen.tsx` — ActionButton · addressPolicy · booking · buildInvoiceHTML · cancelBooking · catLabel · chipRow · closeGroupRescheduleModal · closeInitRescheduleModal · closeRespondModal · CR · dateToIso · displayDuration · formatDisplayDate · groupRescheduleChain · groupSlotResolver · handleAddGroupDateOption · handleAddInitSlot · handleAddSlot · handleCallClient · handleCancel · handleConfirm · handleDecline · handleDeclineRequest · handleInitRescheduleSubmit · handleOpenChat · handlePickCustomTime · handleReleaseAddress · handleRespondSubmit · handleSendGroupReschedule · handleShare · handleStatusChange · hasBeautyData · isAddressReleased · isoToDate · parseMin · Perf · ProviderBookingDetailScreen · Row · s · show · to12 · toggleInitTime · toggleTime · updateBookingStatus
...
- `ProviderClienteleScreen.tsx` — AnnouncementSheet · avatarColor · ClientCard · ClientHistorySheet · daysSince · discountLabel · formatDate · formatShort · handleAnnouncementSent · handleRebook · handleSend · handleSendPromo · handleSheetChange · handleViewHistory · initials · isExpired · load · PromoPickerSheet · ProviderClienteleScreen · snapPoints · TabBar
...
- `BeccaScreen.tsx` — BeccaScreen · buildWelcomeMessage · chatAnimStyle · CLIENT_NAV_SCREENS · formatHeroDate · handleClearHistory · handleDeleteChat · handleHistorySheetChange · handleImagePick · handleLoadChat · handleNewChat · handleProviderPress · handleSend · handleSuggestionPress · heroAnimStyle · historySnapPoints · refreshSessions · scheduleNextTick · thinkingLabelFor
...
- `engine.ts` — buildAmbiguityReply · buildAssumption · buildFallback · buildMissingEntityReply · buildSocialReply · carryForward · **confirmToken** · **converse** · defaultFollowUps · defaultStarters · formatForChat · loadPersonalContext · message_ · resolveOrdinalReference · **respond** · runPendingAction · setPendingAction · topUp
...
- `client.ts` — bookingChoices · soleUpcoming · sortUpcoming
- `shared.ts` — **askChip** · **chip** · **goodNews** · **money** · **navChip** · **providerFromDb** · **resolveProviderDbId** · **softMiss**
