...
**2109 functions** across **272 files**.
...
- `BusinessDetailsKit.tsx` — **Card** · **ChipGroup** · **ChipMultiSelect** · **Field** · **RadioGroup** · **SaveButton** · **SectionLabel** · **Toast** · **ToggleRow** · **useBusinessPalette**
...
- `BusinessInfoScreen.tsx` — BusinessInfoScreen · commitSave · flash · handleSave · isValidEmail · labelFor · toggleServiceCategory
