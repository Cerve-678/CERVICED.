...
- `ProviderMyProfileScreen.tsx` — cardHighlightColors · catalogue · closeEditor · DashCard · DashEmpty · handleAddPhotos · handleEditBranding · handleEditPolicies · handleEditProfile · handleEditSchedule · handleGoLiveStep · handlePress · handleRemovePhoto · handleSaveService · handleSelectCategory · handleSelectTab · handleToggleActive · handleToggleSteps · hasPolicyInfo · load · openEditService · openNewService · policyRows · PP · ProviderMyProfileScreen · ServiceRow · serviceType · setup · themeName · workPhotos
