...
**2116 functions** across **272 files**.
...
- `ProviderScheduleScreen.tsx` — addSplitPeriod · cancelEditingHours · commitBlockDate · dateToYMD · formatTime · formatYMD · handleAddBlock · handleAddOverride · handleOverrideTimeChange · handleRemoveBlock · handleRemoveOverride · handleSaveHours · handleTimeChange · hhmmss · loadData · makeDefault · openOverrideTimePicker · openTimePicker · ProviderScheduleScreen · removeExtraPeriod · startEditingHours · timeToDate · toggleDay · toTime
