...
**1603 functions** across **221 files**.
...
- `CityMultiSelect.tsx` — **CityMultiSelect** · close · filtered · toggle
...
- `LocationPicker.tsx` — **LocationPicker** · saved · selectArea · selectCity · selectRegion
...
- `BookingDetailScreen.tsx` — addRebookToCart · booking · BookingDetailScreen · confirmRebook · getStatusColor · handleCancelBooking · handleRatingSubmit · handleRebook · handleReschedulePress · handleTipSubmit · isPastCancellationWindow · noticeWindowText · openContactSheet · openInMaps · openProviderChat · policyRows · shareReceipt · tick
...
- `RescheduleScreen.tsx` — booking · dateToTimeHHMM · fetchRealRescheduleDates · formatDisplayDate · groupSiblings · handleCustomDateChange · handleCustomTimeChange · handleDateSelect · handleDecline · handleSubmit · handleTimeSelect · minPickerDate · openCustomDatePicker · providerRespondedDates · RescheduleScreen
- `SearchScreen.tsx` — activeFilterChips · clearFilter · filteredProviders · formatPriceRange · handleFilterPress · handleProviderPress · handleRefresh · handleSearchChange · mapDbToCardData · providersWithAvailability · providersWithDistance · providersWithPriceRange · renderHeader · resetFilters · run · SearchScreen · specialtiesFor · updateFilter
- `SubscriptionScreen.tsx` — SubscriptionScreen
- `UserProfileScreen.tsx` — handleBiometricToggle · handleLogout · UserProfileScreen

### `src/screens/provider/` (21)
- `AddBookingScreen.tsx` — AddBookingScreen · handleContinue · handleCreate · hhmmss · load · pickService · pickSlot · toggleAddOn · toMinutes
...
- `InfoRegScreen.tsx` — adaptiveAccentColor · addCategory · AddCategoryModal · applyDragPosition · categoryNames · closeSection · EditCategoryModal · editTheme · fgFor · filled · getCategoryDragResponder · goToNextSection · goToPreviousSection · handleAddAddOn · handleAddCategory · handleAddContraindication · handleAddImage · handleAddPortfolioImages · handleAddTrend · handleDeleteCategory · handleDeleteService · handleInputFocus · handlePickPolicyImage · handleRemoveAddOn · handleRemoveImage · handleRemovePolicyImage · handleRemovePortfolioItem · handleRenameCategory · handleReorderCategory · handleSave · handleSaveService · handleSelectLogo · handleSetCategoryOrder · handleSubmit · handleTransferData · handleTransferPress · InfoRegScreen · isDuplicate · makeStyles · missingRequired · openSection · pickSuggestion · portfolioColumns · PreviewModal · sectionSummaries · serviceCount · ServiceModal · ServiceTemplatePicker · setPolicy · startCategoryAutoScroll · stopCategoryAutoScroll · surfFor · tick · toggleTag · TransferDataModal · useChrome · useScreenStyles
...
### `src/services/becca/` (7)
- `aiRuntime.ts` — **configureBeccaAI** · **getBeccaAIInterpreter**
- `engine.ts` — buildAmbiguityReply · buildAssumption · buildFallback · buildMissingEntityReply · buildSocialReply · carryForward · **confirmToken** · **converse** · defaultFollowUps · defaultStarters · formatForChat · interpretWithTimeout · loadPersonalContext · message_ · resolveOrdinalReference · **respond** · runPendingAction · setPendingAction · splitChatSentences · topUp · understandWithFallback
