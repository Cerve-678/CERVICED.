...
import { updateProviderAutoAccept, updateProviderScheduleSettings, updateProviderCancellationPolicy, getMyProviderProfile } from '../services/databaseService';
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      if (providerId) {
        ...
        saves.push(updateProviderCancellationPolicy(providerId, parseInt(d.cancellationNoticeHours, 10) || 0));
      }
