    ...
    <View style={[styles.root, { backgroundColor: P.bg }]}>
      ...
      {justSubmitted ? (
        ...
        <View style={styles.successState}>
          ...
          <TouchableOpacity
            style={[styles.doneBtn, { backgroundColor: P.accent }]}
            onPress={() => navigation.goBack()}
            activeOpacity={0.8}
          >
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          >
            ...
            {form.requiresSignature && (
              <View style={[styles.qCard, { backgroundColor: P.card, borderColor: P.accent + '55' }]}>
                ...
                <TextInput
                  style={[styles.textAnswer, { color: P.text, backgroundColor: P.bg, borderColor: signature.trim() ? P.accent : P.border, minHeight: 48 }]}
                  value={signature}
        ...
        <View style={styles.optionsList}>
          {(question.options ?? []).filter(o => o.trim()).map((opt, oi) => (
            ...
            >
              <View style={[
                styles.choiceRadio,
                { borderColor: value === opt ? P.accent : P.sub },
              ]}>
