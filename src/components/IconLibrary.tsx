...
const iconPaths = {
  ...
  // Business-type glyphs (providers.business_type). 'salon' uses
  // 'storefront' and 'home_based' uses 'house', both already defined above;
  // these two complete the set so every business_type value has an icon.
  // See BUSINESS_TYPE_ICON in features/providers/profilePresentation.ts.
  'studio-chair': 'M7 4c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v7H7V4zm-2 9c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2v2c0 1.1-.9 2-2 2h-1v3c0 .55-.45 1-1 1s-1-.45-1-1v-3H9v3c0 .55-.45 1-1 1s-1-.45-1-1v-3H6c-1.1 0-2-.9-2-2v-2z',
  'van': 'M3 6c0-1.1.9-2 2-2h8c1.1 0 2 .9 2 2v2h2.4c.6 0 1.2.3 1.6.8l2 2.6c.3.4.4.8.4 1.2V16c0 .55-.45 1-1 1h-1.2c-.4 1.2-1.5 2-2.8 2s-2.4-.8-2.8-2H9.8c-.4 1.2-1.5 2-2.8 2s-2.4-.8-2.8-2H3c-.55 0-1-.45-1-1V6zm12 4v2.5h4.5L17.6 10H15zM7 15c-.8 0-1.5.7-1.5 1.5S6.2 18 7 18s1.5-.7 1.5-1.5S7.8 15 7 15zm10 0c-.8 0-1.5.7-1.5 1.5s.7 1.5 1.5 1.5 1.5-.7 1.5-1.5-.7-1.5-1.5-1.5z',
  ...
  // Icons for ProviderAccountScreen
  ...
  'badge': 'M20 7h-5V4c0-1.1-.9-2-2-2h-2c-1.1 0-2 .9-2 2v3H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm-7 0h-2V4h2v3zm-1 10.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5zm4 2.5H8v-.57c0-1.11.92-2 2.06-2h3.88c1.14 0 2.06.89 2.06 2V20z',
  'swap-horiz': 'M6.99 11L3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z',
  'stack': 'M2 4c0-.55.45-1 1-1h18c.55 0 1 .45 1 1s-.45 1-1 1H3c-.55 0-1-.45-1-1zm1 4.5c-.55 0-1 .45-1 1s.45 1 1 1h18c.55 0 1-.45 1-1s-.45-1-1-1H3zm1 5.5c-.55 0-1 .45-1 1s.45 1 1 1h16c.55 0 1-.45 1-1s-.45-1-1-1H4zm2 5.5c-.55 0-1 .45-1 1s.45 1 1 1h12c.55 0 1-.45 1-1s-.45-1-1-1H6z',
  // Icons for PointsScreen (loyalty points).
  'emoji-events': 'M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94.63 1.5 1.98 2.63 3.61 2.96V19H7v2h10v-2h-4v-3.1c1.63-.33 2.98-1.46 3.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm14 0c0 1.3-.84 2.4-2 2.82V7h2v1z',
  'cake': 'M12 6c1.11 0 2-.9 2-2 0-.38-.1-.73-.29-1.03L12 0l-1.71 2.97c-.19.3-.29.65-.29 1.03 0 1.1.89 2 2 2zm4.6 9.99l-1.07-1.07-1.08 1.07c-1.3 1.3-3.58 1.31-4.89 0l-1.07-1.07-1.09 1.07C6.75 16.64 5.88 17 4.96 17c-.73 0-1.4-.23-1.96-.61V21c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-4.61c-.56.38-1.23.61-1.96.61-.92 0-1.79-.36-2.44-1.01zM18 9h-5V7h-2v2H6c-1.66 0-3 1.34-3 3v1.54c0 1.08.88 1.96 1.96 1.96.52 0 1.02-.2 1.38-.57l1.09-1.07 1.07 1.07c1.31 1.31 3.59 1.32 4.9.01l1.08-1.08 1.07 1.07c.37.37.86.57 1.38.57 1.08 0 1.96-.88 1.96-1.96V12c.01-1.66-1.33-3-2.99-3z',
  ...
  'card-giftcard': 'M20 6h-2.18c.11-.31.18-.65.18-1 0-1.66-1.34-3-3-3-1.05 0-1.96.54-2.5 1.35l-.5.67-.5-.68C10.96 2.54 10.05 2 9 2 7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zM15 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm11 15H4v-2h16v2zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20v6z',
};
